my_list = [2, 4, 5, 9, 19, 20]

for number in my_list:
    print(number)

print('\nSecond loop on the way')
for i in range(10, 14):
    print(i)

print('\nThird loop on the way')
i = 0
while len(my_list) > i:
    print(my_list[i])
    i += 1
...
numbers = [
    ...
    615, 953, 345, 399, 162, 758, 219, 918, 238, 412, 566, 826, 248, 866, 950,
